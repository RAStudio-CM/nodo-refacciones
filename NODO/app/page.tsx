...
const whatsapp = "https://wa.me/541140282551?text=Hola%20NODO%2C%20quiero%20consultar%20por%20una%20visita.";
const email = "nodorefacciones@gmail.com";

function Logo({ cover = false }: { cover?: boolean }) {
  return <span className={`logo ${cover ? "logo-cover" : "logo-compact"}`}>
    <img src={cover ? "/images/nodo-cover-01.jpg" : "/images/nodo-header-02.jpg"} width={1774} height={887} alt={cover ? "NODO — Mantenimiento, reparaciones, reformas y construcciones" : "NODO"} />
  </span>;
}
...
export default function Home() {
  ...
  return <main>
    ...
    <footer className="contact scene reveal" id="contacto">
      ...
      <div className="footer-line"><Logo /><span>© 2026 NODO</span></div>
    </footer>
